...
try {
    ...
    $guzzleEventException = new \Koalamon\Client\Reporter\Event('SiteInfo_BigFiles_' . $url, $system, \Koalamon\Client\Reporter\Event::STATUS_FAILURE, 'SiteInfoBigFile', $message, 0, '', $component_id);
